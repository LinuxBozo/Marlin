...
#define STRING_CONFIG_H_AUTHOR "linuxbozo" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {33.33, 33.33, 1600/5, 55.465}  // default steps per unit for ultimaker
...
#define EXTRUDER_OFFSET_X {0.0, 34.00} // (in mm) for each extruder, offset of the hotend on the X axis
